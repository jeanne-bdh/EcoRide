...
function saveNewCarpool(PDO $pdo, string $localDepart, string $localArrival, string $dateCarpool, string $duration, string $timeDepart, string $timeArrival, int $price, int $usersId, int $carId): bool | int
{
    $stmt = $pdo->prepare("INSERT INTO carpools (localisation_depart, localisation_arrival, date_depart, duration, time_depart, time_arrival, price, id_users, id_status_carpool, id_car) VALUE (:localisation_depart, :localisation_arrival, :date_depart, :duration, :time_depart, :time_arrival, :price, :id_users, :id_status_carpool, :id_car)");
