<?php require_once APP_ROOT . '/src/Utils/helpers.php'; ?>
...
<div class="carpool-card">
    <div class="carpool-card-top">
        ...
        <div>
            ...
            <p class="p-place"><?= $carpool->getRemainingSeat(); ?> place(s)</p>
        </div>
    </div>
    <div class="travel">
        <div class="container-depart">
            <p class="time-style"><?= formatTime($carpool->getTimeDepart()); ?></p>
            <p><?= $carpool->getLocalisationDepart(); ?></p>
        </div>
        <div class="travel-circle"></div>
        <hr class="travel-line">
        <p class="duration"><?= getDuration($carpool->getTimeDepart(), $carpool->getTimeArrival()); ?></p>
        <hr class="travel-line">
        <div class="travel-circle"></div>
        <div class="container-arrival">
            <p class="time-style"><?= formatTime($carpool->getTimeArrival()); ?></p>
            <p><?= $carpool->getLocalisationArrival(); ?></p>
        </div>
    </div>
    <hr>
    <div class="carpool-card-bottom">
        <div class="card-driver">
            ...
            <div class="tag" id="green-tag">
                <p><?= $carpool->getCar()->getTravelType()->getLabelTravelType(); ?></p>
            </div>
        </div>
        <div class="card-inner-bottom">
            <div class="tag tag-status" id="<?= $carpool->getIdCarpool(); ?>" data-status="<?= $carpool->getStatusCarpool()->getLabelStatusCarpool(); ?>">
                <p><?= $carpool->getStatusCarpool()->getLabelStatusCarpool(); ?></p>
            </div>
            <?php if (empty($hideDetailsLink)): ?>
                <div class="details-link">
                    ...
                    <a href="/pages/carpools/carpool_details.php?id_carpool=<?= $carpool->getIdCarpool(); ?>">
                        Voir détails
                    </a>
                </div>
            <?php endif; ?>
