<footer>
    ...
    <section class="section-wave-bottom">
        <div class="section-icons-eco">
            ...
            <div class="icons-eco-items">
                ...
                <p>Simplicité et convivialité</p>
            </div>
        </div>
        <div class="bg-wave-bottom">
            <img src="/assets/images/footer/wave_bottom.svg" alt="wave-bottom">
        </div>
    </section>
    ...
    <section class="section-legal-infos">
        ...
        <div class="container-legal-infos-inner">
            ...
            <div class="legal-link">
                <a href="/pages/legal-infos/legal_infos.php">Mentions légales</a>
                <a href="/pages/legal-infos/privacy_policy.php">Politique de confidentialité</a>
                <a href="/pages/legal-infos/cookie-management.php">Gestion des cookies</a>
                <a href="/pages/legal-infos/cgu.php">CGU</a>
            </div>
        </div>
    </section>
    ...
    <section class="copyright">
        <hr>
        <p>&copy; 2025 - EcoRide - Tous droits réservés - Créé par Jeanne BOUCHEND'HOMME</p>
    </section>
...
<script src="/js/new-carpool.js"></script>
