<div class="carpool-card">
    ...
    <div class="travel">
        <div class="container-depart">
            <p><?= (new DateTime($carpoolSearch['heure_depart']))->format('G\hi'); ?></p>
            <p><?= $carpoolSearch['lieu_depart']; ?></p>
        </div>
        <div class="travel-circle"></div>
        <hr class="travel-line">
        <p class="duree"><?= (new DateTime($carpoolSearch['duree']))->format('G\h'); ?></p>
        <hr class="travel-line">
        <div class="travel-circle"></div>
        <div class="container-arrivee">
            <p><?= (new DateTime($carpoolSearch['heure_arrivee']))->format('G\hi'); ?></p>
