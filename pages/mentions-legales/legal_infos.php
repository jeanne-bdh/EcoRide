...
<section class="container-black">
    ...
    <div class="main-legal-infos">
        ...
        <p>
            ...
            numérique, les responsables du présent site internet www.oseznoel-bymichel.com sont :
        </p>

        <h6>Éditeur du site</h6>
        <p>SARL OsezNoel</p>
        <p>Numéro de SIREN : 123 456 789 10111</p>
        <p>Responsable éditorial : 1234 567891</p>
        <p>Téléphone : 01 23 45 67 89</p>
        <p>Email : contact@oseznoel-bymichel.com</p>
        <p>Site web : www.oseznoel-bymichel.com</p>

        <h6>Hébergement</h6>
        <p>Hébergeur : SARL OsezNoel 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.oseznoel-bymichel.com</p>

        <h6>Développement</h6>
        <p>SARL OsezNoel 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.oseznoel-bymichel.com</p>

        <h6>Conditions d’utilisation</h6>
        <p>
            Ce site www.oseznoel-bymichel.com est proposé en différents langages web (HTML, HTML5, Javascript, CSS,
        ...
        <p>
            L’agence OsezNoel met en œuvre tous les moyens dont elle dispose, pour assurer une information fiable et une
            mise à jour fiable de ses sites internet. Toutefois, des erreurs ou omissions peuvent survenir.
        </p>
        <p>
            L’internaute devra donc s’assurer de l’exactitude des informations auprès de l’agence OsezNoel et signaler
            toutes modifications du site qu’il jugerait utile. OsezNoel n’est en aucun cas responsable de l’utilisation
            faite de ces informations, et de tout préjudice direct ou indirect pouvant en découler.
        </p>

        <h6>Cookies</h6>
        <p>
            Le site www.oseznoel-bymichel.com peut-être amené à vous demander l’acceptation des cookies pour des besoins
            de statistiques et d’affichage. Un cookie est une information déposée sur votre disque dur par le serveur du
        ...
        <p>
            Les sites internet peuvent offrir des liens vers d’autres sites internet ou d’autres ressources disponibles
            sur Internet. L’agence OsezNoel ne dispose d’aucun moyen pour contrôler les sites en connexion avec ses
            sites internet.
        </p>
        <p>
            L’agence OsezNoel ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit.
        ...
        <p>
            ...
            hyperlien en direction de www.oseznoel-bymichel.com sans l’autorisation expresse et préalable de l’agence
            OsezNoel.
        </p>
        <p>
            Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction d’un
            des sites internet de SARL OSEZNOEL, il lui appartiendra d’adresser un email accessible sur le site afin de
            formuler sa demande de mise en place d’un hyperlien.
        </p>
        <p>
            La SARL OSEZNOEL se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa
            décision.
        </p>
        ...
        <p>
            ...
            www.oseznoel-bymichel.com.
        </p>
        <p>
            SARL OSEZNOEL s’efforce de fournir sur le site www.oseznoel-bymichel.com des informations aussi précises que
            possible. Les renseignements figurant sur le site www.oseznoel-bymichel.com ne sont pas exhaustifs et les
            photos non contractuelles.
        </p>
        <p>
            Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs,
            tous les informations indiquées sur le site www.oseznoel-bymichel.com sont données à titre indicatif, et
            sont susceptibles de changer ou d’évoluer sans préavis.
        </p>

        <h6>Limitation contractuelles sur les données</h6>
        <p>
            Les informations contenues sur ce site sont aussi précises que possible et le site est mis à jour à
        ...
        <p>
            ...
            signaler par courriel, à l’adresse contact@oseznoel-bymichel.com, en décrivant le problème de la manière la
            plus précise possible (page posant problème, type d’ordinateur et de navigateur utilisé…).
        </p>
        <p>
        ...
        <p>
            ...
            présentes sur le réseau Internet ne sauraient engager la responsabilité de SARL OSEZNOEL.
        </p>

        <h6>Propriété intellectuelle</h6>
        <p>
            Tout le contenu du présent site www.oseznoel-bymichel.com, incluant, de façon non limitative, les
            graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme
            sont la
        ...
        <p>
            ...
            de ces différents éléments est strictement interdite sans l’accord exprès par écrit de SARL OSEZNOEL. Cette
        ...
        <p>
            ...
            l’informatique, aux fichiers et aux libertés, ce site a fait l’objet d’une déclaration 1656629 auprès de la
            Commission nationale de l’informatique et des libertés (www.cnil.fr).
        </p>

        <h6>Litiges</h6>
        <p>
            Les présentes conditions du site www.oseznoel-bymichel.com sont régies par les lois françaises et toute
            contestation ou litiges qui pourraient naître de l’interprétation ou de l’exécution de celles-ci seront de
            la compétence exclusive des tribunaux dont dépend le siège social de la société. La langue de référence,
        ...
        <p>
            ...
            notre site internet www.oseznoel-bymichel.com.
        </p>
        <p>Cependant, ce principe comporte certaines exceptions.</p>
        <p>
            En effet, pour certains services proposés par notre site, vous pouvez être amenés à nous communiquer des
            données telles que : votre nom, votre fonction, le nom de votre société, votre adresse électronique, et
            votre numéro de téléphone. Tel est le cas lorsque vous remplissez le formulaire qui vous est proposé en
            ligne, dans la rubrique « contact ».
        </p>
        <p>
            Il est à noter que vous pouvez refuser de fournir vos données personnelles. Dans ce cas, vous ne pourrez pas
        ...
        <p>
            ...
            améliorer la qualité des services qui vous sont proposés.
        </p>
        <p>
