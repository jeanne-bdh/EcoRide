...
<main>
    ...
    <section class="main-legal-infos">
        ...
        <p>
            ...
            numérique, les responsables du présent site internet www.ecoride.com sont :
        </p>
        ...
        <p>Site web : www.ecoride.com</p>

        <h5>Hébergement</h5>
        <p>Hébergeur : SARL EcoRide 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.ecoride.com</p>

        <h5>Développement</h5>
        <p>SARL EcoRide 12 Rue du Huit Mai 1945, 60350 ATTICHY – site web : www.ecoride.com</p>

        <h5>Conditions d’utilisation</h5>
        <p>
            Ce site www.ecoride.com est proposé en différents langages web (HTML, HTML5, Javascript, CSS,
        ...
        <p>
            L’agence EcoRide met en œuvre tous les moyens dont elle dispose, pour assurer une information fiable et une
            mise à jour fiable de ses sites internet. Toutefois, des erreurs ou omissions peuvent survenir.
        </p>
        <p>
            L’internaute devra donc s’assurer de l’exactitude des informations auprès de l’agence EcoRide et signaler
            toutes modifications du site qu’il jugerait utile. EcoRide n’est en aucun cas responsable de l’utilisation
            faite de ces informations, et de tout préjudice direct ou indirect pouvant en découler.
        </p>

        <h5>Cookies</h5>
        <p>
            Le site www.ecoride.com peut-être amené à vous demander l’acceptation des cookies pour des besoins
        ...
        <p>
            ...
            sur Internet. L’agence EcoRide ne dispose d’aucun moyen pour contrôler les sites en connexion avec ses
            sites internet.
        </p>
        <p>
            L’agence EcoRide ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit.
        ...
        <p>
            ...
            hyperlien en direction de www.ecoride.com sans l’autorisation expresse et préalable de l’agence
            EcoRide.
        </p>
        <p>
            Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction d’un
            des sites internet de SARL EcoRide, il lui appartiendra d’adresser un email accessible sur le site afin de
            formuler sa demande de mise en place d’un hyperlien.
        </p>
        <p>
            La SARL EcoRide se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa
            décision.
        </p>
        ...
        <p>
            SARL EcoRide s’efforce de fournir sur le site www.ecoride.com des informations aussi précises que
            possible. Les renseignements figurant sur le site www.ecoride.com ne sont pas exhaustifs et les
            photos non contractuelles.
        </p>
        <p>
            Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs,
            toutes les informations indiquées sur le site www.ecoride.com sont données à titre indicatif, et
        ...
        <p>
            ...
            signaler par courriel, à l’adresse contact@ecoride.com, en décrivant le problème de la manière la
        ...
        <p>
            ...
            présentes sur le réseau Internet ne sauraient engager la responsabilité de SARL EcoRide.
        </p>

        <h5>Propriété intellectuelle</h5>
        <p>
            Tout le contenu du présent site www.ecoride.com, incluant, de façon non limitative, les
        ...
        <p>
            ...
            de ces différents éléments est strictement interdite sans l’accord exprès par écrit de SARL EcoRide. Cette
        ...
        <h5>Litiges</h5>
        <p>
            Les présentes conditions du site www.ecoride.com sont régies par les lois françaises et toute
        ...
        <p>
            ...
            notre site internet www.ecoride.com.
        </p>
